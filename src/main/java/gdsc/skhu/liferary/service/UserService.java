...
import gdsc.skhu.liferary.config.SecurityUtil;
import gdsc.skhu.liferary.domain.DTO.UserRequestDTO;
import gdsc.skhu.liferary.domain.DTO.UserResponseDTO;
import gdsc.skhu.liferary.domain.Member;
import gdsc.skhu.liferary.domain.Response;
import gdsc.skhu.liferary.enums.Authority;
...
public class UserService {
    ...
    public ResponseEntity<?> authority() {
        ...
        Member member = usersRepository.findByEmail(userEmail)
